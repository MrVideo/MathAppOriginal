...
int main()
  {
    ...
    par:
      ...
      scanf("%f%f%f",&a,&b,&c);
      par_sel:
        printf("\nLa parabola è orizzontale o verticale?(1/2)\t");
        scanf("%d",&y);
          switch(y)
            {
              case 1:
                      ...
                      switch(x)
                        {
                          ...
                          case 3:
                            dir = -(1+((b*b)-(4*a*c)))/(4*a);
                            printf("\n\nLa formula della direttrice è y=%f\n\n",dir);
                            goto back;
                            break;
                          case 4:
                            axis = -(b/(2*a));
                            printf("\n\nLa formula dell'asse di simmetria è x=%f\n\n",axis);
                            goto back;
                            break;
                          default:
                            printf("\nNon hai digitato un numero accettabile\n\n");
    ...
    back:
      printf("Vuoi continuare, ritornare al menù\nprincipale o terminare il programma?\n");
